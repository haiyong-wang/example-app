...
<head>
    ...
    <title>登录 - {{ config('app.name', '憨憨专属摸鱼网站') }}</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .form-row .remember { display: flex; align-items: center; gap: 6px; cursor: pointer; }
        .form-row .forgot { color: #409eff; }
...
<div class="auth-wrap">
    ...
    <div class="card">
        ...
        <div class="card-sub">登录后继续今天的快乐摸鱼</div>
